...
type DB interface {
	...
	GetCategoriesBySource(ctx context.Context, source sql.NullString) ([]sql.NullString, error)
...
func (s *sqlDB) GetCategoriesBySource(ctx context.Context, source sql.NullString) ([]sql.NullString, error) {
